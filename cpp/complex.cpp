...
class Complex {
   ...
   public:
    ...
    // Function to add the calling object and the object passed as a parameter
    // and return a third object
    ...
    // Function to subtract the object passed as a parameter from the calling
    // object and return a third object
    Complex operator-(Complex c) {
        cout << "Subtracting!\n";
        int real = this->real - c.real;
        int imaginary = this->imaginary - c.imaginary;
    ...
    // Function to multiply the calling object and the object passed as a
    // parameter and return a third object
    Complex operator*(Complex c) {
        cout << "Multiplying!\n";
...
int main() {
    ...
    int choice;
    cout << "1 for addition, 2 for subtraction, 3 for subtraction (the other "
            "way) and 4 for multiplication!\n";
    cout << "Enter choice: ";
    cin >> choice;
...
/* Output:
1 for addition, 2 for subtraction, 3 for subtraction (the other way) and 4 for
multiplication! Enter choice: 1 Enter complex number 1! Real part: 2 Imaginary
part: 3 Enter complex number 2! Real part: 2 Imaginary part: 3 Adding! Complex
number is: 4+6i!

1 for addition, 2 for subtraction, 3 for subtraction (the other way) and 4 for
multiplication! Enter choice: 4 Enter complex number 1! Real part: 2 Imaginary
part: 3 Enter complex number 2! Real part: 4 Imaginary part: 5 Multiplying!
