...
int main() {
    ...
    // Checking the input and performing the desired operation and displaying
    // result
    switch (c) {
        case '+':
...
/* EXECUTION
fpllab@fpllab-OptiPlex-9020:~/Desktop/Akhil$ gcc
./Assignment4_111044_Calculator.c fpllab@fpllab-OptiPlex-9020:~/Desktop/Akhil$
./a.out
