...
class SalariedEmployee : public virtual Employee {
  public:
    ...
    // Parameterized constructor
    SalariedEmployee(string employeeName, int employeeId, float weeklySalary)
    ...
    void calculateSalary() { salary = weeklySalary; }
...
class HourlyEmployee : public Employee {
  public:
    ...
    // Parameterized constructor
    HourlyEmployee(string employeeName, int employeeId, float wage, int hours)
        : Employee(employeeName, employeeId) {
        this->wage = wage;
        this->hours = hours;
        salary = 0;
...
class CommissionEmployee : public virtual Employee {
  public:
    ...
    // Parameterized constructor
    CommissionEmployee(string employeeName, int employeeId, float sale,
                       float rate)
        : Employee(employeeName, employeeId) {
        this->sale = sale;
        this->rate = rate;
    ...
    // Method to calculate the salary
    void calculateSalary() { salary = sale * rate / 100; }
...
// Derived class from SalariedEmployee and CommissionEmployee with multiple
// inheritance
class SalariedCommissionEmployee : public SalariedEmployee,
  ...
  public:
    ...
    // Parameterized constructor
    SalariedCommissionEmployee(float salary)
    ...
    // Method to display the salary
    void display() { cout << "Weekly+Commission salary: " << salary; }
};
...
int main() {
    ...
    cin >> ch;
    // Ignore the newline because of pressing enter key so that we can enter
    // name
    cin.ignore(1, '\n');
    switch (ch) {
    case 1: {
