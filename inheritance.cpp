...
int main()
{
    do { // do-while loop so that user will get prompted until they enter an invalid input
        cout<<"Enter 1 for circle, 2 for rectangle, 3 for triangle, anything else to exit!\n";
        int c;
        cin>>c;
    ...
    } while (1); // infinite loop, program will exit when user enters invalid input
}
