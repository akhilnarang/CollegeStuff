...
class Complex
{
    ...
    public:
        ...
        Complex add(Complex *c) // Method to add the complex numbers and return an object of class Complex which contains sum
        {
            return Complex(c->real+this->real, c->imaginary+this->imaginary);
        }
        Complex subtract(Complex *c) // Method to subtract the complex numbers and return an object of class Complex which contains the difference
        {
            return Complex(c->real-this->real, c->imaginary-this->imaginary);
        }
        void display() // Method to display the the complex number stored in the calling object
        {
...
{
    int real, imaginary;
    // Declaration of variables, prompting user, and accepting input and creation of 2 objects of class Complex
